...
@Repository("esCustomFunctionDao")
public class EsCustomFunctionDaoImpl implements EngScriptFunctionDao,InitializingBean{

	private Logger logger = LoggerFactory.getLogger(this.getClass());						
		
	public final String TABLE = "rule_script_function";
