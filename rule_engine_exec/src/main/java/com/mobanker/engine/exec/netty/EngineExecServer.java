package com.mobanker.engine.exec.netty;
...
public class EngineExecServer {

	private static Logger logger = LoggerFactory.getLogger(EngineExecServer.class);
	...
	public static void main(String[] args) throws Exception {
		...
		MobankerApplication.run(EngineExecServer.class, args);
	}
