...
import com.mobanker.engine.framkwork.util.WildcardMatcherUtil;
...
* @version 1.0 
*/
public class ConditionCharacterLike extends EngineConditionExt {

	/** 
	* @Fields serialVersionUID :序列化
	*/
	private static final long serialVersionUID = 1L;
	private static final String BUSI_DESC = "字符包含字符";	
	...
	public boolean judge(EngineTransferData etd) {
		...
		result=WildcardMatcherUtil.match(paramValue, value);
	...
	public boolean equals(Object obj) {
		if(!(obj instanceof ConditionCharacterLike)) return false;
		ConditionCharacterLike another = (ConditionCharacterLike) obj;	
