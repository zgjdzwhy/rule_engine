/**
 * <p>Title: WildcardMatcher</p>
 * <p>Description: 字符串通配符匹配(* ?)</p>
 * <p>Company: </p> 
 * @author zhujunjie
 * @date 下午6:06:47
 */
 ...
 * 
 * This class provides a method for the programmar to test whether a f
 * ile matches a wildcard.
 * 
 * For he who is familiar with dos, he will probably refer to files us
 * ing wildcard, that is file names
 * like "*.bat","a?b.*",etc, this class gives you a method to test if 
 * they are match.
 * 
 ...
 * ......
 * 
 * Title:        A little part of My Graduate Design Project
 * Description:
...
public class WildcardMatcherUtil {
	...
	/**
	 * Empty construct, since all the methods are static, you don't ha ve to
	 * make an object of this class, and thus I hide the construtor in private.
	 */
	private WildcardMatcherUtil() {
	}
	 ...
	 * 
	 * @param string
	 *            The source string to be compared to the wildcard.
	 * @param wildcard
	 *            The wildcard.
	 * 
	 ...
	 *            The wildcard.
	 * @param ignorecase
	 *            If this param is true, all the comparison is made not
	 *            casesensitive.
	 * 
	 * @return True, if they matches.
	 */
	 ...
	 *            A string to compare
	 * 
	 * @return True If a and b equals, notice that this could be invol ve
	 *         wildcard "?"
	 */
	 ...
	 * 
	 * @param string
	 *            The source string to be compared to the pattern.
	 * @param pattern
	 *            The wildcard contained string.
	 * @param startpos
	 *            The start position of this search.
	 * 
	...
	private static int find(String string, String pattern, int startpos) {
		...
		int orgp, pp = 0, ps = startpos, strlen = string.length(), patternlen = pattern
				.length();
		char pc, sc;
		boolean cmatch;
		orgp = ps;
	...
	public static void main(String[] args) {
		WildcardMatcherUtil aa = new WildcardMatcherUtil();
		System.out.println(aa.match("aaaaabb**bccc", "*a*b*c"));
