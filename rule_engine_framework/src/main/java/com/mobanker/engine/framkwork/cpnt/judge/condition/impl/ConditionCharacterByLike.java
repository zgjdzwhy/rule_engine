...
/**
* <p>Title: ConditionCharacterByLike</p>
* <p>Description: </p>
...
* @version 1.0 
*/
public class ConditionCharacterByLike extends EngineConditionExt {

	/** 
	* @Fields serialVersionUID :序列化
	*/
	private static final long serialVersionUID = 1L;
	private static final String BUSI_DESC = "字符被字符包含";	
	...
	public boolean judge(EngineTransferData etd) {
		...
		if(StringUtils.indexOf(value.trim(),paramValue)>=0){
			result=true;
		}
	...
	public boolean equals(Object obj) {
		if(!(obj instanceof ConditionCharacterByLike)) return false;
		ConditionCharacterByLike another = (ConditionCharacterByLike) obj;	
