...
public class ConditionCharacterLikeParser extends EngineConditionOneAbsParser{
	private static final String BUSI_DESC = "ConditionCharacterLikeParser解析器";
	...
	public EngineConditionExt parse(JSONObject json, EngineCpntParser engineCpntParser) {
		...
		ConditionCharacterLike condition=new ConditionCharacterLike();
		...
		condition.setCmpType(ConditionCharacterLike.class.getSimpleName());
