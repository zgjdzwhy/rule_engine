...
public class ConditionArrayEqualsParser extends EngineConditionOneAbsParser{
	private static final String BUSI_DESC = "ConditionArrayEqualsParser解析器";
	...
	public EngineConditionExt parse(JSONObject json, EngineCpntParser engineCpntParser) {
		...
		ConditionArrayEquals condition=new ConditionArrayEquals();
