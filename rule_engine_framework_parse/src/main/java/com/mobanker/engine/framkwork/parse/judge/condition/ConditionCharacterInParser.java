...
public class ConditionCharacterInParser extends EngineConditionOneAbsParser{
	private static final String BUSI_DESC = "ConditionCharacterInParser解析器";
	...
	public EngineConditionExt parse(JSONObject json, EngineCpntParser engineCpntParser) {
		...
		ConditionCharacterIn condition=new ConditionCharacterIn();
